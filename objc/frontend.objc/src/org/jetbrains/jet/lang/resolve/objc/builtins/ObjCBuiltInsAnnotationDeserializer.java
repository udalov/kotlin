...
/* package */ class ObjCBuiltInsAnnotationDeserializer implements AnnotationDeserializer {
    public static final ObjCBuiltInsAnnotationDeserializer INSTANCE = new ObjCBuiltInsAnnotationDeserializer();
