...
public class InjectorForTopDownAnalyzerForObjC {
    ...
    private final JavaClassFinderPostConstruct javaClassFinderPostConstruct;
    ...
    public InjectorForTopDownAnalyzerForObjC(
        ...
        this.objCBuiltIns = new ObjCBuiltIns(module);
        this.objCPackageFragmentProvider = new ObjCPackageFragmentProvider(project, module, objCBuiltIns);
        ...
        this.javaClassFinderPostConstruct = new JavaClassFinderPostConstruct();
        ...
        javaClassFinder.setComponentPostConstruct(javaClassFinderPostConstruct);
        ...
        javaClassFinderPostConstruct.postCreate();
