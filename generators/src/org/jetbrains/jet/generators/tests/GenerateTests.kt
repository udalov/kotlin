...
fun main(args: Array<String>) {
    ...
    testGroup("compiler/tests", "compiler/testData") {
        ...
        testClass(javaClass<AbstractObjCDescriptorResolverTest>()) {
            model("objc/resolve", recursive = true, extension = "h", testMethod = "doTest")
        }

        testClass(javaClass<AbstractObjCWithJavaTest>()) {
            model("objc/java")
        }
