...
/**
 * True if the system property `kotlin.reflect.jvm.useLegacyImplementation` is set to true.
 *
 ...
 */
internal val useLegacyImplementation = runCatching {
    System.getProperty("kotlin.reflect.jvm.useLegacyImplementation")
 ...
 *
 * This system property instructs kotlin-reflect to load Kotlin metadata metadata directly in the new implementation, avoiding descriptors.
 * This is more efficient if you only use API that is already re-implemented without descriptors. However, this is less efficient if API
