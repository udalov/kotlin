...
public class ObjCDescriptorResolverTestGenerated extends AbstractObjCDescriptorResolverTest {
    public void testAllFilesPresentInResolve() throws Exception {
        JetTestUtils.assertAllTestsPresentByMetadata(this.getClass(), "org.jetbrains.jet.generators.tests.TestsPackage", new File("compiler/testData/objc/resolve"), Pattern.compile("^(.+)\\.h$"), true);
    }
    ...
    public static class Categories extends AbstractObjCDescriptorResolverTest {
        public void testAllFilesPresentInCategories() throws Exception {
            JetTestUtils.assertAllTestsPresentByMetadata(this.getClass(), "org.jetbrains.jet.generators.tests.TestsPackage", new File("compiler/testData/objc/resolve/categories"), Pattern.compile("^(.+)\\.h$"), true);
        }
    ...
    public static class Hierarchy extends AbstractObjCDescriptorResolverTest {
        public void testAllFilesPresentInHierarchy() throws Exception {
            JetTestUtils.assertAllTestsPresentByMetadata(this.getClass(), "org.jetbrains.jet.generators.tests.TestsPackage", new File("compiler/testData/objc/resolve/hierarchy"), Pattern.compile("^(.+)\\.h$"), true);
        }
        ...
        public static class MetaclassInheritance extends AbstractObjCDescriptorResolverTest {
            public void testAllFilesPresentInMetaclassInheritance() throws Exception {
                JetTestUtils.assertAllTestsPresentByMetadata(this.getClass(), "org.jetbrains.jet.generators.tests.TestsPackage", new File("compiler/testData/objc/resolve/hierarchy/metaclassInheritance"), Pattern.compile("^(.+)\\.h$"), true);
            }
    ...
    public static class Methods extends AbstractObjCDescriptorResolverTest {
        public void testAllFilesPresentInMethods() throws Exception {
            JetTestUtils.assertAllTestsPresentByMetadata(this.getClass(), "org.jetbrains.jet.generators.tests.TestsPackage", new File("compiler/testData/objc/resolve/methods"), Pattern.compile("^(.+)\\.h$"), true);
        }
    ...
    public static class Types extends AbstractObjCDescriptorResolverTest {
        public void testAllFilesPresentInTypes() throws Exception {
            JetTestUtils.assertAllTestsPresentByMetadata(this.getClass(), "org.jetbrains.jet.generators.tests.TestsPackage", new File("compiler/testData/objc/resolve/types"), Pattern.compile("^(.+)\\.h$"), true);
        }
