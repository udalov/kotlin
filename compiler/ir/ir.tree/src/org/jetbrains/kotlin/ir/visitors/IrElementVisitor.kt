...
abstract class IrElementVisitor<out R, in D> {
    ...
    open fun visitDeclaration(declaration: IrDeclaration, data: D) = visitElement(declaration, data)
    ...
    open fun <T> visitConst(expression: IrConst<T>, data: D) = visitExpression(expression, data)
    ...
    open fun visitSetVariable(expression: IrSetVariable, data: D) = visitValueAccess(expression, data)
    ...
    open fun visitMemberAccess(expression: IrMemberAccessExpression, data: D) = visitExpression(expression, data)
