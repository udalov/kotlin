...
val typeMappings = mapOf(
    ...
    "CommonIdSignature" to "org.jetbrains.kotlin.ir.util.IdSignature.CommonSignature",
    "AccessorIdSignature" to "org.jetbrains.kotlin.ir.util.IdSignature.AccessorSignature",
    "FileLocalIdSignature" to "org.jetbrains.kotlin.ir.util.IdSignature.FileLocalSignature",
    "CompositeSignature" to "org.jetbrains.kotlin.ir.util.IdSignature.CompositeSignature",
    "LocalSignature" to "org.jetbrains.kotlin.ir.util.IdSignature.LocalSignature",
    "IdSignature" to "org.jetbrains.kotlin.ir.util.IdSignature",
    "FileSignature" to "org.jetbrains.kotlin.ir.util.IdSignature.FileSignature",

    "IrSimpleTypeLegacy" to "org.jetbrains.kotlin.idk.IrSimpleTypeLegacy",
    "IrSimpleTypeNullability" to "org.jetbrains.kotlin.idk.IrSimpleTypeNullability",
    "IrDefinitelyNotNullType" to "org.jetbrains.kotlin.idk.IrDefinitelyNotNullType",
    "IrReturnableBlock" to "org.jetbrains.kotlin.idk.IrReturnableBlock",
    "IrInlinedFunctionBlock" to "org.jetbrains.kotlin.idk.IrInlinedFunctionBlock",
    "IrRichFunctionReference" to "org.jetbrains.kotlin.idk.IrRichFunctionReference",
    "IrRichPropertyReference" to "org.jetbrains.kotlin.idk.IrRichPropertyReference",
    "Loop" to "org.jetbrains.kotlin.idk.Loop",
    "FieldAccessCommon" to "org.jetbrains.kotlin.idk.FieldAccessCommon",
    "IrSetValue" to "org.jetbrains.kotlin.idk.IrSetValue",
    "IrErrorExpression" to "org.jetbrains.kotlin.idk.IrErrorExpression",
    "IrErrorCallExpression" to "org.jetbrains.kotlin.idk.IrErrorCallExpression",
    "IrDeclarationBase" to "org.jetbrains.kotlin.idk.IrDeclarationBase",
    "IrFunctionBase" to "org.jetbrains.kotlin.idk.IrFunctionBase",
    "IrInlineClassRepresentation" to "org.jetbrains.kotlin.idk.IrInlineClassRepresentation",
    "IrMultiFieldValueClassRepresentation" to "org.jetbrains.kotlin.idk.IrMultiFieldValueClassRepresentation",
)
